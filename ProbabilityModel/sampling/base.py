...
from ProbabilityModel import HAS_PANDAS
from ProbabilityModel.utils import _check_1d_array_object, _check_length_equal
...
class BaseGradLogPDF(object):
    ...
    model : An instance of ProbabilityModel.models

    Examples
    --------
    >>> from ProbabilityModel.factors import GaussianDistribution
    >>> from ProbabilityModel.inference.continuous import BaseGradLogPDF
    >>> import numpy as np
    ...
    def get_gradient_log_pdf(self):
        ...
        >>> from ProbabilityModel.sampling.base import GradLogPDFGaussian
        >>> from ProbabilityModel.factors.continuous import GaussianDistribution
        >>> import numpy as np
        >>> mean = np.array([1, 1])
...
class GradLogPDFGaussian(BaseGradLogPDF):
    ...
    Inherits ProbabilityModel.inference.base_continuous.BaseGradLogPDF
    ...
    model : An instance of ProbabilityModel.models.GaussianDistribution

    Example
    -------
    >>> from ProbabilityModel.sampling import GradLogPDFGaussian
    >>> from ProbabilityModel.factors.continuous import GaussianDistribution
    >>> import numpy as np
    >>> mean = np.array([3, 4])
...
class BaseSimulateHamiltonianDynamics(object):
    ...
    grad_log_pdf : A subclass of ProbabilityModel.inference.continuous.BaseGradLogPDF
    ...
    Examples
    --------
    >>> from ProbabilityModel.sampling import BaseSimulateHamiltonianDynamics
    >>> from ProbabilityModel.factors.continuous import GaussianDistribution
    >>> from ProbabilityModel.sampling import GradLogPDFGaussian
    >>> import numpy as np
    ...
    def get_proposed_values(self):
        ...
        >>> from ProbabilityModel.inference.continuous import ModifiedEuler, GradLogPDFGaussian as GLPG
        >>> from ProbabilityModel.factors import GaussianDistribution
        >>> import numpy as np
        >>> pos = np.array([3, 4])
...
class LeapFrog(BaseSimulateHamiltonianDynamics):
    ...
    Inherits ProbabilityModel.inference.base_continuous.BaseSimulateHamiltonianDynamics
    ...
    grad_log_pdf : A subclass of ProbabilityModel.inference.continuous.BaseGradLogPDF, defaults to None
    ...
    --------
    >>> from ProbabilityModel.factors.continuous import GaussianDistribution
    >>> from ProbabilityModel.sampling import LeapFrog, GradLogPDFGaussian as GLPG
    >>> import numpy as np
    >>> pos = np.array([2, 1])
...
class ModifiedEuler(BaseSimulateHamiltonianDynamics):
    ...
    --------
    >>> from ProbabilityModel.factors.continuous import GaussianDistribution
    >>> from ProbabilityModel.sampling import GradLogPDFGaussian, ModifiedEuler
    >>> import numpy as np
    >>> pos = np.array([2, 1])
    >>> momentum = np.array([1, 1])
    >>> mean = np.array([0, 0])
