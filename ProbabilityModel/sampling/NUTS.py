...
from ProbabilityModel.sampling import HamiltonianMCDA, LeapFrog, _return_samples
...
class NoUTurnSampler(HamiltonianMCDA):
    ...
    Example
    -------
    >>> from ProbabilityModel.sampling import NoUTurnSampler as NUTS, LeapFrog, GradLogPDFGaussian
