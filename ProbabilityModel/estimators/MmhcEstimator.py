...
from ProbabilityModel.base import UndirectedGraph
from ProbabilityModel.models import BayesianModel
from ProbabilityModel.estimators import StructureEstimator, HillClimbSearch, BDeuScore
from ProbabilityModel.independencies import Independencies, IndependenceAssertion
from ProbabilityModel.estimators.CITests import chi_square
...
class MmhcEstimator(StructureEstimator):
    ...
    def estimate(self, scoring_method=None, tabu_length=10, significance_level=0.01):
        ...
        scoring_method: instance of a Scoring method (default: BDeuScore)
            ...
            scoring methods implemented in ProbabilityModel.
        ...
        >>> import pandas as pd
        >>> import numpy as np
        >>> from ProbabilityModel.estimators import ConstraintBasedEstimator
