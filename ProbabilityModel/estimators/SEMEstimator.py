...
from ProbabilityModel.models import SEMGraph, SEMAlg, SEM
from ProbabilityModel.global_vars import device, dtype
from ProbabilityModel.utils import optimize, pinverse
...
class SEMEstimator(object):
    ...
    def fit(
        ...
        **kwargs,
        ...
        Parameters
        ----------
        data: pandas DataFrame or ProbabilityModel.data.Data instance
        ...
        **kwargs: dict
        ...
        Returns
        -------
            ProbabilityModel.model.SEM instance: Instance of the model with estimated parameters
...
class IVEstimator:
    ...
    def __init__(self, model):
        ...
        Parameters
        ----------
        model: ProbabilityModel.models.SEM
