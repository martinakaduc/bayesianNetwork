...
from ProbabilityModel.utils.decorators import convert_args_tuple
...
class BaseEstimator(object):
    ...
    def state_counts(self, variable, parents=[], complete_samples_only=None):
        ...
        --------
        >>> import pandas as pd
        >>> from ProbabilityModel.estimators import BaseEstimator
...
class ParameterEstimator(BaseEstimator):
    def __init__(self, model, data, **kwargs):
        """
        Base class for parameter estimators in ProbabilityModel.

        Parameters
        ----------
        model: ProbabilityModel.models.BayesianModel or ProbabilityModel.models.MarkovModel or ProbabilityModel.models.NoisyOrModel
    ...
    def state_counts(self, variable, **kwargs):
        ...
        >>> from ProbabilityModel.estimators import ParameterEstimator
...
class StructureEstimator(BaseEstimator):
    def __init__(self, data=None, independencies=None, **kwargs):
        """
        Base class for structure estimators in ProbabilityModel.
