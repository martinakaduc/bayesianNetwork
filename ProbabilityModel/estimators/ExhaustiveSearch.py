...
from ProbabilityModel.estimators import StructureEstimator, ScoreCache
from ProbabilityModel.estimators import K2Score
from ProbabilityModel.utils.mathext import powerset
...
class ExhaustiveSearch(StructureEstimator):
    ...
    def all_dags(self, nodes=None):
        ...
        --------
        >>> import pandas as pd
        >>> from ProbabilityModel.estimators import ExhaustiveSearch
    ...
    def all_scores(self):
        ...
        >>> import pandas as pd
        >>> import numpy as np
        >>> from ProbabilityModel.estimators import ExhaustiveSearch, K2Score
    ...
    def estimate(self):
        ...
        >>> best_model
        <ProbabilityModel.base.DAG.DAG object at 0x7f695c535470>
        >>> best_model.edges()
        [('B', 'C')]
        """
