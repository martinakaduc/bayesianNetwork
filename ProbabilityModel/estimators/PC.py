...
from ProbabilityModel.base import PDAG
from ProbabilityModel.estimators import StructureEstimator
from ProbabilityModel.estimators.CITests import chi_square, pearsonr, independence_match
...
class PC(StructureEstimator):
    ...
    def build_skeleton(
        ...
        **kwargs,
        ...
        --------
        >>> from ProbabilityModel.estimators import ConstraintBasedEstimator
        >>> from ProbabilityModel.models import DAG
