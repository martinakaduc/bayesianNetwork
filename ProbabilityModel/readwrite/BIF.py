...
class BIFReader(object):
    ...
    def __init__(self, path=None, string=None, include_properties=False, n_jobs=-1):
        ...
        >>> reader = BIFReader("bif_test.bif")
        <ProbabilityModel.readwrite.BIF.BIFReader object at 0x7f2375621cf8>
        """
        if path:
    ...
    def get_model(self, state_name_type=str):
        ...
        >>> reader = BIFReader("bif_test.bif")
        >>> reader.get_model()
        <ProbabilityModel.models.BayesianModel.BayesianModel object at 0x7f20af154320>
        """
        try:
            model = BayesianModel()
...
class BIFWriter(object):
    ...
    def __init__(self, model):
        ...
        Examples
        ---------
        >>> from ProbabilityModel.readwrite import BIFWriter
...
$properties}\n"""
    ...
    def get_variables(self):
        ...
        Example
        -------
        >>> from ProbabilityModel.readwrite import BIFReader, BIFWriter
