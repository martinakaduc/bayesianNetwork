...
def get_example_model(model):
    ...
    ProbabilityModel.model instance.
    ...
    Example
    -------
    >>> from ProbabilityModel.data import get_example_model
    >>> model = get_example_model(model='asia')
    >>> model

    Returns
    -------
    ProbabilityModel.models instance: An instance of one of the model classes in ProbabilityModel.models
