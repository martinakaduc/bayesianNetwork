...
from ProbabilityModel.factors.distributions import BaseDistribution
...
class GaussianDistribution(BaseDistribution):
    ...
    def __init__(self, variables, mean, cov):
        ...
        --------
        >>> import numpy as np
        >>> from ProbabilityModel.factors.distributions import GaussianDistribution as GD
    ...
    def pdf(self):
        ...
        Examples
        --------
        >>> from ProbabilityModel.factors.distributions import GaussianDistribution
        ...
        ...                [-2, -5, 8]])
        >>> dist.pdf
        <function ProbabilityModel.factors.distributions.GaussianDistribution.GaussianDistribution.pdf.<locals>.<lambda>>
        >>> dist.pdf([0, 0, 0])
        0.0014805631279234139
        """
    ...
    def to_canonical_factor(self):
        ...
        -6.51533
        """
        from ProbabilityModel.factors.continuous import CanonicalDistribution
