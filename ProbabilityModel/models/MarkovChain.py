...
from ProbabilityModel.utils import sample_discrete
...
class MarkovChain(object):
    ...
    >>> from ProbabilityModel.models import MarkovChain as MC
    >>> model = MC()
    ...
    def prob_from_sample(self, state, sample=None, window_size=None):
        ...
        Examples
        --------
        >>> from ProbabilityModel.models.MarkovChain import MarkovChain as MC
        >>> from ProbabilityModel.factors.discrete import State
    ...
    def generate_sample(self, start_state=None, size=1):
        ...
        Examples
        --------
        >>> from ProbabilityModel.models.MarkovChain import MarkovChain
        >>> from ProbabilityModel.factors.discrete import State
        >>> model = MarkovChain()
    ...
    def copy(self):
        ...
        Examples
        --------
        >>> from ProbabilityModel.models import MarkovChain
        >>> from ProbabilityModel.factors.discrete import State
        >>> model = MarkovChain()
        >>> model.add_variables_from(['intel', 'diff'], [3, 2])
        >>> intel_tm = {0: {0: 0.2, 1: 0.4, 2:0.4}, 1: {0: 0, 1: 0.5, 2: 0.5}, 2: {0: 0.3, 1: 0.3, 2: 0.4}}
