...
from ProbabilityModel.factors.discrete import (
    TabularCPD,
    JointProbabilityDistribution,
    DiscreteFactor,
)
from ProbabilityModel.factors.continuous import ContinuousFactor
from ProbabilityModel.models.MarkovModel import MarkovModel
...
class BayesianModel(DAG):
    ...
    def add_cpds(self, *cpds):
        ...
        --------
        >>> from ProbabilityModel.models import BayesianModel
        >>> from ProbabilityModel.factors.discrete.CPD import TabularCPD
    ...
    def fit(
        ...
        >>> import pandas as pd
        >>> from ProbabilityModel.models import BayesianModel
        >>> from ProbabilityModel.estimators import MaximumLikelihoodEstimator
        ...
        """
        from ProbabilityModel.estimators import MaximumLikelihoodEstimator, BaseEstimator
