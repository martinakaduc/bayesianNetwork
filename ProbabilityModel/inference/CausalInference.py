...
from ProbabilityModel.estimators.LinearModel import LinearEstimator
from ProbabilityModel.utils.sets import _powerset, _variable_or_iterable_to_set
...
class CausalInference(object):
    ...
    >>> from ProbabilityModel.inference.causal_inferece import CausalInference
