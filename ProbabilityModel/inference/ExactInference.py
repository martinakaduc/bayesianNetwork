...
from ProbabilityModel.inference.EliminationOrder import (
    WeightedMinFill,
    MinNeighbors,
    MinFill,
    MinWeight,
)
from ProbabilityModel.models import JunctionTree, BayesianModel
...
class BeliefPropagation(Inference):
    ...
    def calibrate(self):
        ...
        >>> from ProbabilityModel.inference import BeliefPropagation
